...
//        imageButton_backbuttons = toolbar.findViewById(R.id.backbtntopteams);
   ...
   private  void getIntentValue(){
    ...
    private void  Load(){
        ...
        list.add(new TopsTeamsItems(8,8,1,R.drawable.fcbarcelona,"Barcelona","Spain","Ronald Koeman","Captain Sergio Busquets","Futbol Club Barcelona, commonly referred to as Barcelona and colloquially known as Barça, is a Spanish professional football club based in Barcelona, Spain, that competes in La Liga, the top flight of Spanish footbal" ,"1899-present",mainurl+"es.png"));
        ...
        list.add(new TopsTeamsItems(11,1,2,R.drawable.bel,"Red Lions","BELGIUM","Michel van den Heuvel","Félix Denayer","Belgium won the Men's Hockey World Cup in 2018, the European Championship in 2019, the 2020-21 FIH Pro League and the gold medal at 2020 Tokyo Olympics.","1907-Present", mainurl+"be.png"));
        ...
        list.add(new TopsTeamsItems(15,5,2,R.drawable.ger,"Honamas","Germany","Toni Söderholm","Tobias Hauke","The Germany men's national field hockey team is one of the most successful sides in the world, winning gold at the Summer Olympics four times, the Hockey World Cup twice, the EuroHockey Nations Championship eight times and the Hockey Champions Trophy nine times." ,"1888-present",mainurl+"de.png"));
        list.add(new TopsTeamsItems(16,6,2,R.drawable.eng,"Team GB","England","Danny Kerry","Adam Dixon","England Hockey is the national governing body for the sport of field hockey in England. There are separate governing bodies for the sport in the other parts of the United Kingdom." ,"1920-present",mainurl+"gb.png"));
        list.add(new TopsTeamsItems(17,7,2,R.drawable.arg,"Los Leones (The Lions)","Argentina","Carlos Retegui","Pedro Ibarra","The Argentina national field hockey team represents Argentina in field hockey and is governed by the Argentine Hockey Confederation (CAH).","1973-present", mainurl+"ar.png"));
        ...
        list.add(new TopsTeamsItems(33,3,4,R.drawable.rus,"Reds Caesar Land", "Russia","Tuomas Sammelvuo","Igor Kobzar","The Russia men's national volleyball team is governed by the Russian Volleyball Federation and takes part in international volleyball competitions. FIVB considers Russia as the inheritor of the records of Soviet Union and CIS.","1949-present",mainurl+"ru.png"));
